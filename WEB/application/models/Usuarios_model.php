		...
		*/
		...
		switch (true) {
			...
			case ( (strlen($a['nombres']) == 0)):
				$this->msj = "Ingresa sus Nombres.";
				break;
			case ( (strlen($a['appaterno']) == 0)):
				$this->msj = "Ingresa Apellido Paterno.";
				break;
			case ( (strlen($a['apmaterno']) == 0)):
				$this->msj = "Ingresa Apellido Materno.";
				break;
			case ( (strlen($a['correo']) == 0)):
				$this->msj = "Ingresa Correo Electronico.";
				break;
			case ( (strlen($a['usuario']) == 0)):
				$this->msj = "Ingresa nombre de Usuario.";
				break;
			case ( (strlen($a['clave']) == 0)):
				$this->msj = "Ingresa Clave.";
				break;
			case ( (strlen($a['dni']) == 0)):
				$this->msj = "Ingresa DNI.";
				break;
			case ( (strlen($a['tipo']) == 0)):
				$this->msj = "Ingresa Tipo de Usuario.";
				break;
			case ( (strlen($a['saldo']) == 0)):
				$this->msj = "Ingresa Saldo.";
				break;
			default:

				if($b == 1) $this->CrearUsuario($a); 
				else $this->ModificarUsuario($a);
